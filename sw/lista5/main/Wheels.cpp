...
const float IMPULSES_PER_CM = 1.87;    // Ile impulsów to 1 cm? Zmierz to doświadczalnie.
const float IMPULSES_PER_DEGREE = 0.31; // Ile impulsów to 1 stopień obrotu autka?
...
void Wheels::goForward(int cm)
{
    ...
    this->setSpeed(200); // Prędkość bazowa
    this->forward();
